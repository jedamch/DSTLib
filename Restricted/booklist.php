...
<!-- Making sure that the books themselves are loaded. -->
    <?php 
    ...
    <!-- Standard list to display book information. -->
    ...
    <table class="styled-table">
        ...
        <tbody>
        <?php
        /* Portecting against XSS, adding the hyperlink so the admin can quickly edit books.  */
