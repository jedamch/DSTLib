...
/* Making sure that only admins can use the site.  */
requirerole(['Admin']);

$success = "";
$error = "";

/* PHP for when the admin enters the neccessary data to add a book. */
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($title) || empty($authorid)) {
        ...
        /* Handles the upload of the book cover.  */
...
/* This displays the dashboard to return back to the other pages. */
?>
<!DOCTYPE html>
<html lang="en">
<head>
