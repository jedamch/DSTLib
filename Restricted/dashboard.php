...
/* Ensuring only admins can see this page. */
requirerole(['Admin']);
...
<body>
 ...
 <main class="admin-main">
    ...
    <!-- This is for viewing and editing books. -->
    ...
    <!-- Managing Users as well as reports and suggestions. -->
